...
В ходе анализа выяснилось, что установление мер ***`VISIBILITY`***, ***`EXTINCTION COEFFICIENT`***, ***`OPTICAL DENSITY`***, ***`PATH OBSCURATION`*** и ***`ABSORPTION COEFFICIENT`*** в качестве самостоятельных параметров, воздействующих на дымовой пожарный извещатель, являет ошибку по меньшей мере $\approx1..11\text{%}$, которая на дистанции в 100 секунд моделирования стремительно дисперсирует до 7.6 секунд с поправкой на шаг дискретизации. Это означает, что к 200-й секунде ошибка составит до 12 секунд, а к 300-й секунде – до 25 секунд с поправкой на шаг дискретизации.
...
$$\text{Нп} = \left[\ln\left(\frac{X}{X_0}\right)\right] = 1$$
