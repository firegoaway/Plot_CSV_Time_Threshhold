...
Последние 2 друг от друга никак не отличаются, разница лишь в том, что ***EXTINCTION COEFFICIENT*** использует ***дБ/м*** в качестве единицы измерения, а ***OPTICAL DENSITY - Нп/м***, а также соответствующие критические значения: ***0.2 дБ/м*** и ***0.023 Нм/м***.
