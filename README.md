...
Параметр *VISIBILITY* - весьма перспективный параметр, воздействующий на дымовой пожарный извещатель. Он выбран не случайно, поскольку является частью спектрально-массовой характеристики веществ в FDS, учитывает не только водяной пар, но и прочие химические составы, которые пользователь добавляет в рекацию. В общем, это такой беспристрастный и совокупный параметр. Расчёт критического значения по видимости для пожарного извещателя представлен в файле **Расчёт_VisL.sm**. Файл можно открыть с помощью [**SMath**](https://www.smath.com/ru-RU/).
