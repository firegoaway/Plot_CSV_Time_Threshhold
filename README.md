...
> Начиная с версии ***0.3.1*** работает только в связке с утилитой [**Zmejka**](https://github.com/firegoaway/Zmejka). При этом утилиту всё ещё можно легко адаптировать для внедрения в телеграм-бота.
