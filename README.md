...
Таким образом *EXTINCTION COEFFICIENT* и *OPTICAL DENSITY* - это одно и то же. Разница лишь в том, что в **PCTT** для ***EXTINCTION COEFFICIENT*** в качестве единицы измерения используется ***дБ/м***, а для ***OPTICAL DENSITY*** используется ***Нп/м***, а также соответствующие критические значения: ***0.2 дБ/м*** и ***0.023 Нп/м*** соответстенно, согласно [**приложению 11 Методики 1140**](https://ivo.garant.ru/#/document/406577165/paragraph/1532/doclist/6480/1/0/0/%D0%BC%D0%B5%D1%82%D0%BE%D0%B4%D0%B8%D0%BA%D0%B0%201140:0).
